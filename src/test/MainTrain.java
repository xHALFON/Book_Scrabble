...
public class MainTrain {
	...
	public static void testBoard() {
		...
		// בדיקת חוק המילה השישית:
		Word pi = new Word(get("PI"), 4, 8, true);
		if (b.tryPlaceWord(pi) != 9) {
			System.out.println("Problem in placeWord for 6th word (-10)");
		}

// בדיקת חוק המילה השביעית:
		Word at = new Word(get("AT"), 6, 4, false);
		if (b.tryPlaceWord(at) != 7) {
